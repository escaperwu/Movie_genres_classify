...
# 保存模型
model.save('saved_model/bert_movie_genre_classifier')
print("模型已保存到 saved_model/bert_movie_genre_classifier")
...
def plot_history(history):
    ...
    plt.tight_layout()
    plt.savefig('training_history_bert.png')
    plt.show()
...
print("评估指标已保存到 metrics_bert.json")
